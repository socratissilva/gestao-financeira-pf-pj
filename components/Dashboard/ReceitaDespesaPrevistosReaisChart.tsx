...
interface ReceitaDespesaPrevistosReaisChartProps {
  data: Array<{
    mes: string;
...
export function ReceitaDespesaPrevistosReaisChart({
  data,
}: ReceitaDespesaPrevistosReaisChartProps) {
  ...
  return (
    <div className="bg-white rounded-lg p-6 border border-gray-200">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Comparação entre valores planejados e efetivamente realizados
      </p>
