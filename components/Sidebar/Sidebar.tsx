...
const NAV: NavEntry[] = [
...

  {
    ...
    children: [
      ...
      { label: "Despesas Provisionadas", href: "/financeiro/despesas-previstas", icon: TrendingDown },
      { label: "Despesas Realizadas", href: "/financeiro/despesas-realizadas", icon: TrendingDown },
